...
const translations = {
  en: {
    ...
    pay_full_in_cash:
      "Pay the full amount (€{amount}) in cash on photoshoot day.",
  },
  tr: {
    secure_booking: "Güvenli Rezervasyon",
    pay_full_in_cash:
      "Tüm tutarı (€{amount}) fotoğraf çekimi günü nakit olarak ödeyin.",
  },
  de: {
    secure_booking: "Sichere Buchung",
    pay_full_in_cash:
      "Bezahlen Sie den vollen Betrag (€{amount}) in bar am Tag des Fotoshootings.",
  },
  es: {
    secure_booking: "Reserva Segura",
    pay_full_in_cash:
      "Pague el monto total (€{amount}) en efectivo el día de la sesión de fotos.",
  },
  fr: {
    secure_booking: "Réservation Sécurisée",
    pay_full_in_cash:
      "Payez le montant total (€{amount}) en espèces le jour de la séance photo.",
  },
  ru: {
    secure_booking: "Безопасное бронирование",
    pay_full_in_cash:
      "Оплатите полную сумму (€{amount}) наличными в день фотосессии.",
  },
  ar: {
    secure_booking: "حجز آمن",
    pay_full_in_cash:
      "ادفع المبلغ بالكامل (€{amount}) نقدًا في يوم جلسة التصوير.",
  },
  zh: {
    secure_booking: "安全预订",
  ...
  ro: {
    ...
    pay_full_in_cash:
      "Plătiți suma integrală (€{amount}) în numerar în ziua ședinței foto.",
  },
};
...
for (const loc of locales) {
  try {
    ...
    data.checkout.security.pay_full_in_cash =
      translations[loc].pay_full_in_cash;
