...
export const blogTranslationInputSchema = z.object({
  title: z
    .string()
    .min(1, "validation.blog.title_required")
  ...
  excerpt: z
    ...
    .optional()
    .or(z.literal("")),
  content: z.string().min(1, "validation.blog.content_required"),
  meta_description: z
    .string()
...
export const categoryTranslationInputSchema = z.object({
  name: z
    .string()
    .min(1, "validation.blog.category_name_required")
...
export const tagTranslationInputSchema = z.object({
  name: z
    .string()
    .min(1, "validation.blog.tag_name_required")
