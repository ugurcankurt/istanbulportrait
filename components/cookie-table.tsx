        ...
        <div className="space-y-4">
            ...
            <div className="rounded-md border overflow-x-auto">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead className="min-w-[120px]">{t("columns.name")}</TableHead>
                            <TableHead className="min-w-[200px]">{t("columns.purpose")}</TableHead>
                            <TableHead className="min-w-[100px]">{t("columns.type")}</TableHead>
                            <TableHead className="min-w-[100px]">{t("columns.duration")}</TableHead>
                            <TableHead className="min-w-[120px]">{t("columns.provider")}</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {cookies.map((cookie) => (
