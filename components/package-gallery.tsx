            ...
            <div className="overflow-hidden rounded-xl border border-border shadow-md bg-muted/20" ref={emblaRef}>
                <div className="flex">
                    {images.map((src, index) => (
                        <div className="flex-[0_0_100%] min-w-0 relative aspect-[4/3] sm:aspect-[16/9]" key={index}>
                            <Image
                                src={src}
            ...
            <div className="mt-4 flex justify-center gap-2 px-4 overflow-x-auto pb-2">
                {images.map((src, index) => (
                    <button
                        ...
                        className={cn(
                            "relative h-16 w-24 sm:h-20 sm:w-32 flex-shrink-0 rounded-md overflow-hidden transition-all duration-300 border-2",
                            index === selectedIndex
