...
export function BlogSummary({ summary }: BlogSummaryProps) {
  ...
  return (
    <aside aria-label="Article Summary" className="my-8 rounded-4xl border border-white/10 dark:border-white/5 shadow-md bg-primary/5 backdrop-blur-md p-6 relative overflow-hidden">
