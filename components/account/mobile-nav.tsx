...
export function MobileNav({
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent
        side="left"
        className="w-72 p-0 flex flex-col bg-card border-r border-border/50"
      >
          ...
          <SheetTitle>
            <div className="relative flex items-center w-40 h-8 mt-2">
              {settings?.logo_url ? (
                ...
                <span className="font-bold text-xl tracking-tight dark:hidden">
              ...
              {settings?.logo_dark_url ? (
                ...
                !settings?.logo_url && (
                  <span className="font-bold text-xl tracking-tight hidden dark:block">
                    {settings?.site_name || "IstanbulPortrait"}
                  </span>
                )
              )}
