...
export function PackageForm({ initialData }: PackageFormProps) {
  ...
  const handleAITranslate = async () => {
    ...
    if (
      ...
      !data.duration?.en ||
      !data.features?.en ||
      !data.meta_description?.en ||
      !data.meta_keywords?.en
    ) {
      toast.error(
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      const masterSlug =
        data.slug || generateNativeSlug(data.title.en || "unknown-package");
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Core details about this photography package.
                </CardDescription>
              </CardHeader>
                      ...
                      >
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>
                                Duration string ({loc.toUpperCase()})
                              </FormLabel>
                              <FormControl>
                                <Input
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  placeholder={`Detailed description in ${loc}...`}
                                  className="min-h-32"
                                  {...field}
                                  value={field.value || ""}
                                />
                          ...
                          <Label className="block font-semibold">
                            ...
                            {loc !== "en" && (
                              <span className="text-xs text-muted-foreground ml-2 font-normal">
                                (Auto-syncs length with English)
                              </span>
                            )}
                          </Label>
                          <ul className="space-y-2">
                            ...
                            {(loc === "en"
                              ...
                              <li
                                key={
                                  loc === "en"
                                    ? (featureFieldsEn[index] as any).id
                                    : `feat-${loc}-${index}`
                                }
                              ...
                              >
                                <FormField
                                  ...
                                  render={({ field }) => (
                                    <FormControl>
                                      <Input
                                        placeholder={`Feature ${index + 1} in ${loc}`}
                                        {...field}
                                        value={field.value || ""}
                                      />
                                    </FormControl>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea
                                    placeholder={`SEO description in ${loc}...`}
                                    className="min-h-20"
                                    {...field}
                                    value={field.value || ""}
                                  />
                                ...
                                <FormDescription>
                                  Google search result snippet description.
                                </FormDescription>
                              </FormItem>
                            )}
                          />
                            ...
                            <ul className="space-y-2">
                              {(loc === "en"
                                ...
                                <li
                                  key={
                                    loc === "en"
                                      ? (keywordFieldsEn[index] as any).id
                                      : `kw-${loc}-${index}`
                                  }
                                  className="flex gap-2 items-center"
                                >
                                  <FormField
                                    ...
                                    render={({ field }) => (
                                      <FormControl>
                                        <Input
                                          placeholder={`Keyword ${index + 1} in ${loc}`}
                                          {...field}
                                          value={field.value || ""}
                                        />
                                      </FormControl>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upload photos (auto-optimized max 150KB WebP).
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <div className="flex gap-2">
                        <FormControl>
                          <Input
                            placeholder="e.g. YouTube, Vimeo, or Instagram URL"
                            {...field}
                            value={field.value || ""}
                          />
                        </FormControl>
                      ...
                      <FormDescription>
                        Paste a link OR upload a direct .mp4 video for seamless
                        autoplay.
                      </FormDescription>
                    </FormItem>
                  )}
