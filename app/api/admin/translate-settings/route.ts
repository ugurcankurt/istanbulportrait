...
export async function POST(req: Request) {
  try {
    ...
    const { site_description, address, working_hours } = body;
    ...
    const prompt = `
You are a professional localization expert. Your task is to translate the following English Site Settings into the following languages: ${TARGET_LOCALES.join(", ")}.
