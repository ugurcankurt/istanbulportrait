...
// The supported languages (en is source)
...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `
You are a professional localization expert. Your task is to translate the following English blog category details into the following languages: ${TARGET_LOCALES.join(", ")}.
