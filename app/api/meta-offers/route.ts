...
export async function GET(request: Request) {
  try {
    ...
    let csv =
      "offer_id,title,value_type,percent_off,application_type,public_coupon_code,target_type,target_granularity,target_selection,start_date_time,end_date_time\n";
    ...
    for (const promo of activePromos) {
      ...
      const defaultEnd = promo.end_date
