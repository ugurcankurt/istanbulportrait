...
const PAGE_CONFIGS = [
  ...
  { slug: "home-hero", type: "Section", label: "Home Base - Hero Area" },
  {
    slug: "home-portfolio",
    type: "Section",
    label: "Home Base - Portfolio Gallery",
  },
  {
    slug: "home-packages",
    type: "Section",
    label: "Home Base - Packages Intro",
  },
  {
    slug: "home-instagram",
    type: "Section",
    label: "Home Base - Instagram Feed",
  },
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage titles and subtitles for core public pages (About, Privacy,
            etc).
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader className="border-b">
          ...
          <CardDescription>
            A list of all static routes managed via CMS.
          </CardDescription>
        </CardHeader>
